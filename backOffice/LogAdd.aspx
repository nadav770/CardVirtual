<%@ Page Title="" Language="C#" MasterPageFile="~/backOffice/main.Master" AutoEventWireup="true" CodeBehind="LogAdd.aspx.cs" Inherits="CardVirtual.backOffice.LogAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainCnt" runat="server">
    <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">הוסף תיעוד</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="default.aspx">דף הבית</a>
                                </li>
                                <li class="breadcrumb-item"><a href="LogList.aspx">תיעודים</a>
                                </li> 
                                <li class="breadcrumb-item active">הוספת תיעוד
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                           ...
                           <div class="row">
                             ...
                             <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <asp:TextBox ID="TxtCustomerId" runat="server" class="form-control" placeholder="נא הזן מזהה לקוח" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
